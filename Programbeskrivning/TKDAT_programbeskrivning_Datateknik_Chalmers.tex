...
%  {\small (5-8 sidor)}
%  courselinks are for the academic year 2012/2013
\newcommand{\courselink}[2]{\href{https://www.student.chalmers.se/sp/course?course_id=#1}{#2}}

\newcommand{\introFP }{\courselink{18181}{Introduktion till funktionell programmering}}
\newcommand{\DiskMat }{\courselink{18178}{Inledande diskret matematik}}
\newcommand{\DigoDat }{\courselink{18359}{Grundläggande datorteknik (ny)}}
\newcommand{\LinAlg  }{\courselink{18401}{Linjär algebra}}
\newcommand{\OOP     }{\courselink{18384}{Objektorienterad programmering (flyttad/ny)}}
\newcommand{\MatAn   }{\courselink{17780}{Matematisk analys}}
\newcommand{\MOP     }{\courselink{18360}{Programmering av inbyggda system (ny)}}
\newcommand{\ElKrets }{\courselink{17725}{Elektriska kretsar och fält}}

\newcommand{\DatProj }{\courselink{18381}{Datatekniskt projekt (ny)}}
\newcommand{\MaStDiMa}{\courselink{17210}{Matematisk statistik och diskret matematik}}
\newcommand{\DStr    }{\courselink{17181}{Datastrukturer}}
\newcommand{\FyIng   }{\courselink{17109}{Fysik för ingenjörer}}
\newcommand{\DigSynt }{\courselink{17117}{Digitalteknik-syntes}}
\newcommand{\ParProg }{\courselink{18455}{Parallell programmering}}
\newcommand{\ProgPara}{\courselink{18233}{Programmerings\-paradigmer}}
\newcommand{\DaSyTe  }{\courselink{17826}{Datorsystemteknik}}
\newcommand{\Datakom }{\courselink{17180}{Datakommunikation}}

\newcommand{\Barkraft}{\courselink{TODO} {? Ny Bärkraftig resursanvändning}}
\newcommand{\TraSiSy }{\courselink{18174}{? Ny (Transformer, signaler och system)}}
\newcommand{\Regler  }{\courselink{17931}{? Ny Reglerteknik}}
\newcommand{\Kandarb }{\courselink{18162}{Kandidatarbete}}

%*** electives owned by TKDAT
\newcommand{\OS}      {\courselink{18155}{Operativsystem}}% Y3P2
\newcommand{\FP}      {\courselink{18341}{Functional programming (for non-CSE students)}} % Y3P2
